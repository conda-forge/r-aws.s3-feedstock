...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3336&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-aws.s3-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-aws.s3` can be installed with `conda`:
...
```
mamba install r-aws.s3
```

It is possible to list all of the versions of `r-aws.s3` available on your platform with `conda`:
...
```
mamba search r-aws.s3 --channel conda-forge
```
...
mamba repoquery search r-aws.s3 --channel conda-forge

# List packages depending on `r-aws.s3`:
mamba repoquery whoneeds r-aws.s3 --channel conda-forge

# List dependencies of `r-aws.s3`:
mamba repoquery depends r-aws.s3 --channel conda-forge
```
